...
const AllReview = () => {
    return (
        <div className="lg:flex items-center justify-center w-full md:overflow-y-auto">
            <div className="lg:mr-7 lg:mb-0 mb-7 bg-white p-6 shadow">
                <div className="flex items-center border-b border-gray-200 pb-6">
                    <img src="https://cdn.tuk.dev/assets/components/misc/doge-coin.png" className="w-12 h-12 rounded-full" alt='' />
