...
const ReviewStatitics = () => {
    return (

        <div className="flex flex-col bg-gray-300 md:min-h-[400px] p-8 shadow-sm lg:p-12">
            <div className="flex flex-col w-full text-black">
                ...
                <p className="text-sm text-center text-gray-800">861 global ratings</p>
...
export default ReviewStatitics;